                            ...
                            <div style={{ paddingLeft: `${level * 24}px` }} className="flex items-center space-x-3">
                                ...
                                {item.image ? (
                                    ...
                                    <div className={cn(
                                        ...
                                        level === 0 ? "bg-brand-50 text-brand-600 ring-2 ring-brand-50" : "bg-purple-50 text-purple-600"
                                    )}>
                                        {level === 0 ? <FolderOpen className="h-4 w-4" /> : <Folder className="h-4 w-4" />}
                                    </div>
                                )}
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center space-x-1.5">
                                        <span className={cn(
                                            ...
                                            level === 0 ? "font-bold text-gray-900" : "font-semibold text-gray-700"
                                        )}>
                                            {item.name}
                                        </span>
                        ...
                        <div className="flex items-center space-x-1 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0 mr-1.5">
                            <div className="flex -space-x-0.5 items-center mr-1.5">
                                {item.children?.length > 0 && (
                                    <span className="mr-1 text-[9px] font-bold text-gray-400">{item.children.length} categories</span>
                                )}
                            </div>
        ...
        <div className="ds-section-spacing animate-in fade-in slide-in-from-bottom-2 duration-700 pb-16">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="ds-description mt-0.5">Organize your store by grouping items into Header Categories and Categories.</p>
                </div>
            ...
            <div className="space-y-4">
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
                    ...
                    <Card className="lg:col-span-1 border-none shadow-sm ring-1 ring-brand-50 bg-gradient-to-tr from-brand-50 to-white p-4 flex flex-col justify-between overflow-hidden relative">
                        <div className="z-10">
                            <p className="ds-label text-brand-400 mb-1">Total Groups</p>
                            <h4 className="ds-stat-medium text-brand-900 line-height-none">
                                {isLoading ? '...' : filteredCategories.length}
                            </h4>
                            <p className="text-[10px] font-semibold text-brand-400 mt-1">2-Level Hierarchy</p>
                        </div>
                ...
                <div className="xl:col-span-4 space-y-6">
                    <Card className="bg-slate-900 border-none shadow-xl p-6 rounded-xl text-white relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-500 text-[10px] font-black uppercase tracking-widest mb-6">2-Level Catalog Structure</p>

                            <div className="space-y-4">
                                {[
                                    { step: '1', title: 'Header Categories', desc: 'Main navigation headers (e.g., Grocery, Electronics).', color: 'bg-brand-500' },
                                    { step: '2', title: 'Categories', desc: 'Product categories (e.g., Dairy, Snacks). Products belong directly here.', color: 'bg-purple-500' },
                                ].map((item, i) => (
                            ...
                            <div className="flex-1 p-6 lg:p-8 relative">
                                ...
                                <div className="space-y-6">
                                    <header>
                                        ...
                                        <h3 className="text-xl font-bold text-slate-900">{editingItem ? 'Edit Category Unit' : 'Create New Unit'}</h3>
                                    </header>
