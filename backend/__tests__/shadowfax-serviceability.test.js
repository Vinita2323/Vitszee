...
describe("Shadowfax Serviceability Suite", () => {
  beforeEach(() => {
    ...
    process.env.SHADOWFAX_FORWARD_PROD_TOKEN = "test_forward_prod_token";
    process.env.SHADOWFAX_REVERSE_PROD_TOKEN = "test_reverse_prod_token";
  ...
  it("should return serviceable=true when Forward API responds with success", async () => {
    ...
    expect(mockAxios).toHaveBeenCalledWith(
      expect.objectContaining({
        method: "GET",
        url: expect.stringContaining("/api/v1/clients/serviceability/"),
        params: expect.objectContaining({ service: "seller_pickup", pincodes: "560001" }),
      })
    );
  });
